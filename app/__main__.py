...
class App(tk.Tk):
    ...
    def __init__(self):
        ...
        self.geometry(f"{self.win_width}x{self.win_height}+{self.x_position}+{self.y_position}")
    ...
    def set_window_size_and_position(self):
        ...
        self.y_position = screen_height // 2 - self.win_height // 2 - round(screen_height * 0.03)
